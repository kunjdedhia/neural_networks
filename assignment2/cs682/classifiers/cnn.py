...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        output_volume = (1 + (input_dim[1] - 2)//2) * (1 + (input_dim[2] - 2)//2) * num_filters
        self.params['W2'] = np.random.normal(0.0, weight_scale, size=(output_volume, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        dscores, dw3, db3 = affine_backward(dout, fc2_cache)
        dfc1_out, dw2, db2 = affine_relu_backward(dscores, fc1_cache)
        dconv_out, dw1, db1 = conv_relu_pool_backward(dfc1_out, conv_cache)
